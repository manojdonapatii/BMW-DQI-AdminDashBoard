...
String file_path = "https://rsa.dqi.co.in:8443/";
...
<html>
    ...
    <div id="wrapper">
                ...
                <div class="col-md-12">
                                ...
                                <div class="card-box">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade show active" id="home">
											...
											<form method="post" action="<%=dashboardURL %>notifyExceptions">
                        <div class=" table-responsive">
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                <c:forEach var="qBean" items="${questionnaireList}" varStatus="status">
                                <tr>
                                    <td>${qBean.section }</td>
                                     <td>${qBean.number }</td>
                                      ...
                                      <%-- <td><a target="_balnk" href="http://bmw.dqi.co.in/BMW_UI/uploads/questionnairy_images/${year }/${phase }/${qBean.reference_image }"><img src="http://bmw.dqi.co.in/BMW_UI/uploads/questionnairy_images/${year }/${phase }/${qBean.reference_image }" style="height: 60px; width: 60px;border-radius: 50%;"></a></td> --%>
                                     <td>
                                      <c:forEach var="count" items="${imageList.get(status.index)}">
                                   <a target="_blank" href="<%=file_path %>BMW_UI/uploads/questionnairy_images/${year }/${phase }/${count.reference_image }"><img src="<%=file_path %>BMW_UI/uploads/questionnairy_images/${year }/${phase }/${count.reference_image }" style="height: 60px; width: 60px;border-radius: 50%;"></a>
                                    </c:forEach>
                                      
                                      </td>
                                      <td>${qBean.auditor_comment }</td> 
                                      <td>${qBean.dealer_comment }</td>                                       
                                    <td><%-- <select name="answer"><option value="${ qBean.answer }">${ qBean.answer_type}</option><option value="1">YES</option><option value="0">NO</option></select> --%><a href="#custom-modal" class="audit-id"  data-animation="fadein" data-plugin="custommodal"
                               data-overlaySpeed="200" data-overlayColor="#36404a" data-id="${qBean.audit_id}">NSC Closure</a></td>
                            ...
                            <div class="form-group text-right m-b-0">
                            	<input type="hidden" id="did" value="${did }">
                                   <!--  <button class="btn btn-gradient waves-effect waves-light" type="button">
                                        notify exceptions
                                    </button> -->
      ...
      <div id="custom-modal" class="modal-demo">
            ...
            <form action="<%=dashboardURL %>updatePMOComments" method="Post">
             <div class="row">
             <input type="hidden" value="${dealer_id }" name="dealer_id">
             <input type="hidden" value="${outlet_id }" name="outlet_id">
             <input type="hidden" value="${audit_schedule_id }" name="audit_schedule_id">
             <!--  <table>
            <tr><th>Auditor Comments:</th><td id="auditor_comment"></td></tr><tr><th>Dealer Comments:</th><td id="dealer_comment"></td></tr><tr></tr>
            </table>
            <br> -->
             <div class="col-lg-12">
             <div class="row">
           <div class="form-group col-md-6">
            <label>Auditor Comments:<textarea  style="width: 261px;" name="auditor_comment" id="auditor_comment" class="form-control"></textarea></label>
           <!-- <p id="auditor_comment"></p> -->
            </div>
            <div class="form-group col-md-6">
             <label>Dealer Comments:<textarea  style="width: 261px;" name="dealer_comment" id="dealer_comment" class="form-control"></textarea></label>
           <!-- <p id="dealer_comment"></p> -->
            </div>
            <div class="form-group col-md-6">
              <label id="date-label">Timeline</label>
           <input type="text" id="end_date" name="end_date" placeholder=""  data-mask="99/99/9999" value="${uBean.end_date }" class="form-control">
            </div>
             <div class="form-group col-md-6">
              <label>Result</label>
            ...
            <input type="hidden" name="badge" value="NO">
          
             
               <div class="form-group col-md-6">
            <label>NSC Exception Remarks</label>
               <textarea required="required" name="exception_remarks" id="exception_remarks" class="form-control"></textarea>
               </div> 
       ...
       <%--  $(".btn.btn-gradient.waves-effect.waves-light").click(function (){
        	var did = $("#did").val();
        	
        $.ajax({
	        url: "<%=dashboardURL%>notifyExceptions",
	        type: "GET", 
            data: { 'did': did },
    	...
    	$("#auditor_comment").empty();
    	$("#dealer_comment").empty();
    	        ...
    	        success: function(response)
    	        			...
    	        			var jsonString=JSON.parse(qList);
        	        	   		for(var i=0;i<jsonString.length;i++)
        	        	 	    {
        	        	 	 	  ...
        	        	 	 	  $("#auditor_comment").append(jsonString[i].auditor_comment);
        	        	 	 	  $("#dealer_comment").append(jsonString[i].dealer_comment);
        	        	 	 	  $("#end_date").val(jsonString[i].end_date);
        	        	 	 	  $("#exception_remarks").val(jsonString[i].exception_remarks);
 	       	        	 	    }
