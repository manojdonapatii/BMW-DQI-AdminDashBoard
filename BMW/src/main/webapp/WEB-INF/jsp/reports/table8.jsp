            ...
            <div class="col-md-7">
                <table class="table table-bordered">
                    ...
                    <tr class="bg-grey">
                        ...
                        <td class="size"><span><span class="big-txt mr-ryt">6.2<sup>1</sup></span>The air conditioned diagnostics and calibration room was not available</span></td>
                    </tr>
                    <tr class="bg-grey">
                        <td class="txt-grey size">Workbays , rooms and equipment</td>
                        <td class="size"><span><span class="big-txt mr-ryt">6.30<sup>1</sup></span>Brake test stand was not available in the workshop. The issue was also highlighted in H-2, 2017.</span></td>
                    </tr>                    
                </table>
            </div>
            <div class="col-md-5">
