            ...
            <div class="col-md-7">
                <table class="table table-bordered">
                    ...
                    <tr class="bg-grey">
                        ...
                        <td class="size"><span><span class="big-txt mr-ryt">3.18<sup>2</sup></span>LED screen available was of 38" instead of 46"</span></td>
                    </tr>
                    <tr class="bg-grey">
                        <td class="txt-grey size">Sales Area</td>
                        <td class="size"><span><span class="big-txt mr-ryt">3.22<sup>2</sup></span>Noted that MRP label on accessories displayed had very dark BMW logo. The outer circle of logo is appearing as jet black</span></td>
                    </tr>
                    <tr class="bg-grey">
                        <td class="txt-grey size">Sales Area</td>
                        <td class="size"><span><span class="big-txt mr-ryt">3.06<sup>1</sup></span>Noted different format of name plate in case of X-5 as compared to other cars</span></td>
                    </tr>                    
                </table>
            </div>
            <div class="col-md-5">
