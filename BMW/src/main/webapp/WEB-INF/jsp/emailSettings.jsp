				...
				<div class="col-lg-8 col-md-8 col-sm-8">                        
                      ...
                      <div class="card-box">
                       <div class="header">
                        ...
                        <form id="basic-form" method="POST" action="<%=dashboardURL %>emailSettings">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group">
                                        <label for="phone" class="control-label">Email</label>
                                        <input type="text"  id="email" name="email" value="${emailp}" class="form-control" placeholder="hema@codebele.com" required >
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="password"   id="password" value="${password}" name="password" class="form-control" placeholder="Enter password" required >
                                        <!-- <span class="help-block">(999) 999-9999</span> -->
                                    </div>
                            </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group">
                                        <label for="phone" class="control-label">SMTP Host</label>
                                        <input type="text" value="${smtp_host}" id="smtp_host" name="smtp_host" class="form-control" placeholder="Enter smtp host" required >
                                        <!-- <span class="help-block">(999) 999-9999</span> -->
                                    </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group">
                                        <label for="phone" class="control-label">SMTP Port</label>
                                        <input type="text"  value="${smtp_port}" id="smtp_port" name="smtp_port" class="form-control" placeholder="Enter smtp port" required >
                                        <!-- <span class="help-block">(999) 999-9999</span> -->
                                    </div>
                            </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group">
                                        <label for="phone" class="control-label">SMTP Security Type</label>
                     <select id="smtp_security_type" name="smtp_security_type" required class="form-control" >
                                      <option value="${smtp_security_type}">${smtp_security_type}</option>
                 ...
                 <!-- <span class="help-block">(999) 999-9999</span> -->
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group">
                                        <label for="phone" class="control-label">SMTP settings  For</label>
                     <select id="smtp_settings_for" name="smtp_settings_for" required class="form-control" >
                                      <option value="${smtp_settings_for}">${smtp_settings_for}</option>
