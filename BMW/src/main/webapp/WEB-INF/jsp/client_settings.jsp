                            ...
                            <div class="btn-group pull-right">
                                <ol class="breadcrumb hide-phone p-0 m-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">System Settings</a></li>
                                     <li class="breadcrumb-item"><a href="#">Client Settings</a></li>
                                </ol>
                            </div>
                            <h4 class="page-title">Client Settings</h4>
                        </div>
                    </div>
                </div>
...
<!-- tab menu-->
        ...
        <div class="col-lg-3 col-md-3 col-sm-3">
			<div class="card">
                          ...
                          <button onclick="location.href='<%=dashboardURL%>clientSettings';" class="btn btn-light button-width active"><i class="icon-camera"></i><span class="text-aligning">Client Settings</span></button>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group">
                                     ...
                                     <input type="text" required class="form-control" value="${client_name}" id="client_name" name="client_name" placeholder="Enter Client Name">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3">
                                    ...
                                    <input type="file"   class="form-control"   id="file" name="files" >
                                      <input type="hidden"   class="form-control" value="${client_logo}"  id="default_logo" name="default_logo" >
                                </div>
                            </div>
                             <div class="col-lg-3 col-md-3 col-sm-3">
                                    <div class="form-group">
                <img alt="" src="<%=UI_PATH%>uploads/client_logo/${client_logo}" id="fileoutput" name="files" style="width: 69px;border-radius: 140px; height: 69px;">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                    ...
                                    <input type="text" required class="form-control" value="${mobilep}"  id="mobile" name="mobile" placeholder="Enter Mobile ">
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group">
                                        <label for="Address">Primary Email<span class="text-danger">*</span></label>
                                    <input type="text" required class="form-control" value="${emailp}"  id="email" name="email" placeholder="Enter Email ">
                                </div>
                            </div>
                            </div>
