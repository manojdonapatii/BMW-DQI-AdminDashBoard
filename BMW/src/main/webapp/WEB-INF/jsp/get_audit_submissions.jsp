                        ...
                        <div class=" table-responsive">
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                <tr>
                                   ...
                                   <a target="_balnk" href="<%=file_path %>BMW_UI/uploads/questionnairy_images/${year }/${phase }/${count.reference_image }"><img src="<%=file_path %>BMW_UI/uploads/questionnairy_images/${year }/${phase }/${count.reference_image }" style="height: 60px; width: 60px;border-radius: 50%;"></a>
                                    </c:forEach>
                               ...
                               data-overlaySpeed="200" data-overlayColor="#36404a" data-id="${qBean.audit_id}">Action</a></td>
        ...
        <!-- Signup modal content -->
           ...
           <!-- <p id="dealer_comment"></p> -->
            ...
            <option value="Close">Close</option>
             ...
             <div class="form-group col-md-6">
            <label>PMO Closure Comments</label>
