    ...
    <div id="wrapper">
       ...
       <div class="content-page">
                ...
                <div class="col-md-12">
                                <div class="card-box">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade show active" id="home">
											...
											<form method="post" action="<%=dashboardURL %>addExceptionsTimings/${did}/${oid}/${asid}">
                        <div class=" table-responsive">
                            ...
                            <table class="table table-striped table-bordered" cellspacing="0" width="100%">
                               ...
                               data-overlaySpeed="200" data-overlayColor="#36404a" data-id="${qBean.audit_id}">Action</a><br><a target="_blank" href="<%=dashboardURL%>dealer_exceptions/${did}/${oid}/${asid}">Submissions</a></td>
        ...
        <!-- Signup modal content -->
            ...
            <form action="<%=dashboardURL %>updateCommentsPMO" method="Post">
             <div class="row">
             <div class="col-lg-12">
             <div class="row">
           ...
           <input type="text" id="end_date" name="end_date" placeholder="DD/MM/YYYY"  data-mask="99/99/9999" value="${uBean.end_date }" class="form-control auditDatel">
            </div>
    	        			...
    	        			var jsonString=JSON.parse(qList);
        	        	   		for(var i=0;i<jsonString.length;i++)
        	        	 	    {
    							  ...
    							  $("#comments").append(jsonString[i].comment);    
        	        	 	 	  ...
        	        	 	 	  $("#exception_remarks").text(jsonString[i].exception_remarks);
        	        	 	    }
