                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td>${uBean.first_name }</td>
                                      ...
                                      <td>${uBean.mobile }</td>
                                      <td>${uBean.email }</td>                                        
                                    <td><a href="<%=dashboardURL%>editUser/${uBean.user_id}" class="fa fa-edit"></a>&nbsp;&nbsp;&nbsp;<a href="<%=dashboardURL%>deleteUser/${uBean.user_id}" class="fa fa-trash" onclick="return confirm('Are you sure you want to delete this item?');"></a></td>
                                </tr>
                                </c:forEach>
                                </tbody>
                            </table>
