       ...
       <div class="content-page">
                ...
                <div class="col-lg-4">
                        ...
                        <div class="card-box ">
                            ...
                            <form method="POST" action="<%=dashboardURL %>createDealership" enctype="multipart/form-data" id="formid" autocomplete="off">
                                <div class="form-group col-md-12">
                                    <label for="Address">Dealership Name<span class="text-danger">*</span></label>
                                    <input type="text" required class="form-control" id="dealership_name" name="dealership_name" placeholder="Enter dealership name">
                                </div>
                                <div class="form-group col-md-12">
                                      <label for="Address">Client's Logo<span class="text-danger"></span></label>
                                    <input type="file"   class="form-control"   id="img" name="files" onclick="validateFileType()" accept="image/x-png,image/gif,image/jpeg">
                            	</div>
                                <div class="form-group col-md-12">
                                    <label for="Address">Dealer Principle <span class="text-danger">*</span></label>
                                    <input type="text" required class="form-control" id="contact_person" name="contact_person" placeholder="Enter contact person">
                                </div>
                                 <div class="form-group col-md-12">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" required class="form-control" id="lat" name="lat" placeholder="Enter latitude">
                                </div>
                                <div class="form-group col-md-12">
                                    <label for="Address">Longitude<span class="text-danger">*</span></label>
                                    <input type="text" required class="form-control" id="lang" name="lang" placeholder="Enter longitude">
                                </div>
                                <div class="form-group col-md-12">
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td>${uBean.dealership_name }</td>
                                      ...
                                      <td>${uBean.email }</td>
                                      <td>${uBean.mobile }</td>
                                    <td><a href="<%=dashboardURL%>editDealership/${uBean.dealership_id}" class="fa fa-edit"></a>&nbsp;&nbsp;&nbsp;<a href="<%=dashboardURL%>deleteDealership/${uBean.dealership_id}" class="fa fa-trash" onclick="return confirm('Are you sure you want to delete this item?');"></a></td>
                                </tr>
                                </c:forEach>
                                </tbody>
                            </table>
        ...
        <script src="<%=UI_PATH %>assets/js/imageValidation.js"></script>
        ...
        <script type="text/javascript">
            ...
            function validateFileType(){
             ...
             document.getElementById('file').innerHTML="<span id='info' style='color:red;'>Only Images are allowed!</span>";
                }   
            }
        </script>
