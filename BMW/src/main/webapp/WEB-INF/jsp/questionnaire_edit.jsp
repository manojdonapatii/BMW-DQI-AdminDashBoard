       ...
       <div class="content-page">
                ...
                <div class="content">
                    ...
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Update Questionnaire</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                        ...
                        <div class="card-box ">
                            ...
                            <form method="POST" action="<%=dashboardURL %>editQuestionnaire/${qid }" enctype="multipart/form-data" autocomplete="off">
                               <div class="row">
                              <div class="form-group col-md-6" >
                               ...
                               <div class="form-group col-md-5" >
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" required class="form-control" id="standard" name="standard" value="${standard }" placeholder="Enter standard">
                                </div>
                              	 <div class="form-group col-md-6">
                                    <label for="Address">Standard Number<span class="text-danger">*</span></label>
                                    <input type="text" required class="form-control" id="number" name="number" value="${number}" placeholder="Enter number">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="Address">Requirement<span class="text-danger">*</span></label>
                                    <textarea class="form-control" name="requirement" id="requirement">${requirement }</textarea>
                                </div>
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-3">
                                   ...
                                   <option value="${image_manadatory }">${image_manadatory }</option>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <textarea class="form-control" name="observation" id="observation">${observation }</textarea>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="Address">Suggested Person To Ask<span class="text-danger">*</span></label>
                                    <input type="text" required class="form-control" id="person" name="person" value="${person }" placeholder="Enter suggested person">
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="Address">Image</label>
                                   <input type="file"   class="form-control"   id="file" name="files" >
                                      <input type="hidden"   class="form-control" value="${file}"  id="default_logo" name="default_logo" >
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    <div class="form-group">
                			<img alt="" src="<%=UI_PATH%>uploads/questionnary/${file}" id="fileoutput" name="files" style="width: 69px;border-radius: 140px; height: 69px;">
                                </div>
                            </div>
                             <%-- <div class="form-group col-md-6">
                                    <label for="Address">Best Practice</label>
                                    <textarea class="form-control" name="best_practice"   id="best_practice">${best_practice}</textarea>
                                </div> --%>
                                </div>
                                ...
                                <div class="form-group text-right m-b-0">
                                   ...
                                   <%-- <a href="<%=dashboardURL%>viewQuestionnaire"> --%><form action="<%=dashboardURL%>viewQuestionnaire"> <button type="submit" class="btn btn-light waves-effect m-l-5" >
                                        Cancel
                                    </button></form><!-- </a> -->
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form class="form-horizontal" action="<%=dashboardURL %>section" method="POST">
                                                ...
                                                <div class="form-group m-b-25">
                                                    <div class="col-12">
                                                        <label for="emailaddress1">Section</label>
