       ...
       <div class="content-page">
                ...
                <div class="content">
                    ...
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Create / Add State</h4>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-3 col-md-3 col-sm-3">
			<div class="card">
                          ...
                          <button onclick="location.href='<%=dashboardURL%>city';" class="btn btn-light button-width active"><i class="icon-camera"></i><span class="text-aligning">Manage Cities</span></button>
                         </div>
                    </div>
			</div>
                <div class="col-lg-3">
                        ...
                        <div class="card-box ">
                            ...
                            <form method="POST" action="<%=dashboardURL %>createCity" enctype="multipart/form-data" autocomplete="off">
                                <div class="form-group col-md-12">
                                 ...
                                 <div class="form-group col-md-12">
                                    ...
                                    <input type="text" required   class="form-control" id="city_name" name="city_name" placeholder="Enter city name">
                                </div>
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td>${uBean.state_name }</td>
                                     <td>${uBean.city_name }</td>
                                    <td><a href="<%=dashboardURL%>editCity/${uBean.city_id}" class="fa fa-edit"></a>&nbsp;&nbsp;&nbsp;<a href="<%=dashboardURL%>deleteCity/${uBean.city_id}" class="fa fa-trash" onclick="return confirm('Are you sure you want to delete this item?');"></a></td>
                                </tr>
                                </c:forEach>
                                </tbody>
                            </table>
