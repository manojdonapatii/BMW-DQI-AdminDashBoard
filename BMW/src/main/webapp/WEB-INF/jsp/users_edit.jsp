...
<html>
    ...
    <div id="wrapper">
        ...
        <div class="content-page">
                ...
                <div class="col-lg-12">
                        ...
                        <div class="card-box ">
                            ...
                            <form method="POST" action="<%=dashboardURL %>editUser/${uid }" enctype="multipart/form-data" autocomplete="off">
                               <div class="row">
                               ...
                               <div class="form-group col-md-5" >
                                    ...
                                    <option value="${user_type_id }">${user_type }</option>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" required class="form-control" id="first_name" name="first_name" value="${first_name }" placeholder="Enter first name">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="Address">Last Name<span class="text-danger">*</span></label>
                                    <input type="text" required class="form-control" id="last_name" name="last_name" value="${last_name }" placeholder="Enter last name">
                                </div>
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="password" required class="form-control" id="password" name="password" value="${password }" placeholder="Enter password"  min="8">
                                </div>
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group text-right m-b-0">
                                    ...
                                    <a href="<%=dashboardURL%>viewUser"><button type="button" class="btn btn-light waves-effect m-l-5">
                                        Cancel
                                    </button></a>
		...
		<input type="hidden" id="outlet_id" value="${outlets }">
        <!-- Footer -->
		...
		function getOutlets() 
        {
        	var outlet_id=$("#outlet_id").val();
        	  ...
        	  $.ajax({
        	        url: "<%=dashboardURL%>getOutletsById",
        	        type: "GET", 
        	        ...
        	        success: function(response)
        	                    {
				        			...
				        			var jsonString=JSON.parse(Data);
				        	 	    ...
				        	 	    {
				        	 	 	  $("#outlets").append("<option selected='' value='"+jsonString[i].outlet_id+"'>"+jsonString[i].outlets+"-"+jsonString[i].brand+"-"+jsonString[i].outlet_type+"-"+jsonString[i].dealership_name+"</option>");
				        	 	    }                   
        	                    }
        	        });
        }
