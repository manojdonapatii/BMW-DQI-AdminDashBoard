       ...
       <div class="content-page">
                ...
                <div class="col-lg-4">
                        ...
                        <div class="card-box ">
                            ...
                            <form method="POST" action="<%=dashboardURL %>update_model/${mid }" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" required class="form-control" id="model" name="model" placeholder="Enter model" value=${model }>
                                </div>
