       ...
       <div class="content-page">
                ...
                <div class="content">
                    ...
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Email / email</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                        ...
                        <div class="card-box ">
                            ...
                            <form method="POST" action="<%=dashboardURL %>check-email" enctype="multipart/form-data" autocomplete="off">
                                
                                 <div class="form-group col-md-12">
                                    <label for="state_name">Email<span class="text-danger">*</span></label>
                                    <input type="text" required   class="form-control" id="email" name="email" placeholder="Enter email address">
                                	<p>${status }</p>
                                </div>
                                <div class="form-group text-right m-b-0">
                                    <button class="btn btn-gradient waves-effect waves-light checkmail" type="button">
                                        Submit
                                    </button>
