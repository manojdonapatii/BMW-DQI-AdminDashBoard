       ...
       <div class="content-page">
                        ...
                        <div class="page-title-box">
                            <div class="btn-group pull-right">
                                <ol class="breadcrumb hide-phone p-0 m-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">Brand Models</a></li>
                                </ol>
                            </div>
                            <h4 class="page-title">Brand Models</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                        ...
                        <div class="card-box ">
                            ...
                            <form method="POST" action="<%=dashboardURL %>model" enctype="multipart/form-data" autocomplete="off">
                                <div class="form-group col-md-12">
                                    <label for="Address">Brand<span class="text-danger">*</span></label>
                                ...
                                <div class="form-group col-md-12">
                                    <label for="Address">Model<span class="text-danger">*</span></label>
                                    <input type="text" required class="form-control" id="model" name="model" placeholder="Enter model">
                                </div>
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td>${uBean.brand }</td>
                                      <td>${uBean.type }</td>
                                      <td>${uBean.model }</td>
                                    <td><a href="<%=dashboardURL%>model/${uBean.model_id}" class="fa fa-edit"></a>&nbsp;&nbsp;&nbsp;<a href="<%=dashboardURL%>delete_model/${uBean.model_id}" class="fa fa-trash" onclick="return confirm('Are you sure you want to delete this item?');"></a></td>
                                </tr>
                                </c:forEach>
                                </tbody>
                            </table>
