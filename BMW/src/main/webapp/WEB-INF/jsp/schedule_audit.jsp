                ...
                <%-- <div class="col-lg-5">
                     ...
                     <div class="col-md-6">
                        ...
                        <label>Select Type<span class="text-danger">*</span></label>
                            ...
                            <input type="hidden" name="outlet_type" id="otype" value="${type }">
                             </div>
                            ...
                            <%-- <table class="table">
                                ...
                                <tr>
                                    <td>${uBean.outlets }</td>
                                    <td><input type="text" id="audit_date" name="audit_date" placeholder="" required data-mask="99/99/9999" value="${uBean.audit_date }" class="form-control"></td>
                                  	<td><input type="text" id="end_date" name="end_date" placeholder="" required data-mask="99/99/9999" value="${uBean.end_date }" class="form-control"></td>
                                    ...
                                    <input type="hidden" name="outlets" id="outlets" value="${uBean.outlets }">
                                  	<td><select class="form-control select2" name="user_id" name="user_id"><c:forEach var="uBean" items="${auditorList}"><option value="${uBean.user_id }">${uBean.first_name}</option></c:forEach></select></td>
                                </tr>
