       ...
       <div class="content-page">
        ...
        <div class="col-lg-3 col-md-3 col-sm-3">
			<div class="card">
                          ...
                          <button onclick="location.href='<%=dashboardURL%>state';" class="btn btn-light button-width active"><i class="icon-camera"></i><span class="text-aligning">Manage States</span></button>
                ...
                <div class="col-lg-3">
                        ...
                        <div class="card-box ">
                            ...
                            <form method="POST" action="<%=dashboardURL %>createState" enctype="multipart/form-data" autocomplete="off">
                                <div class="form-group col-md-12">
                                    <label for="state_name">State Name<span class="text-danger">*</span></label>
                                    <input type="text" required class="form-control" id="state_name" name="state_name" placeholder="Enter state name">
                                </div>
                        ...
                        <div class="card-box table-responsive">
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td><a href="<%=dashboardURL%>editState/${uBean.state_id}" class="fa fa-edit"></a>&nbsp;&nbsp;&nbsp;<a href="<%=dashboardURL%>deleteState/${uBean.state_id}" class="fa fa-trash" onclick="return confirm('Are you sure you want to delete this item?');"></a></td>
                                </tr>
                                </c:forEach>
                                </tbody>
                            </table>
