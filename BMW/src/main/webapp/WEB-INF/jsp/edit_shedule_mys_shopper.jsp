...
<html>
    ...
    <body onload="getOutlets();getModels();">
    <div id="wrapper">
        <!-- Navigation Bar-->
       ...
       <div class="content-page">
                        ...
                        <div class="page-title-box">
                            <div class="btn-group pull-right">
                                <ol class="breadcrumb hide-phone p-0 m-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">Update MYS Visit</a></li>
                                </ol>
                            </div>
                            <h4 class="page-title">Update MYS Visit</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                        ...
                        <div class="card-box ">
                            ...
                            <form method="POST" action="<%=dashboardURL %>updateMysteryShopper/${uid }" enctype="multipart/form-data" autocomplete="off">
                               <div class="row">
                              
                               <div class="form-group col-md-6">
                                    <label for="Address">Name<span class="text-danger">*</span></label>
                                    <input type="text" required class="form-control" id="first_name" name="first_name" value="${name }" placeholder="Enter full name">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="Address">Age<span class="text-danger">*</span></label>
                                    <input type="text" required class="form-control" id="age" name="age" value="${age }" placeholder="Enter age">
                                </div>
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" required class="form-control" id="mobile" name="mobile" value="${contact_numebr }" placeholder="Enter contact number">
                                </div>
                                <div class="form-group col-md-3">
                               ...
                               <div class="form-group col-md-3">
                                    ...
                                    <input type="text" id="visit_date" name="visit_date" placeholder="DD/MM/YYYY" value="${visit_date }" required data-mask="99/99/9999" value="${uBean.audit_date }" class="form-control">
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="pass1">Brand<span class="text-danger">*</span></label>
                                    <select id="brand" name="brand" required class="form-control" onchange="getModels();">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select id="type" name="type" required class="form-control" onchange="getOutlets();">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select id="outlets" name="outlets" class="select2 form-control select2-multiple" required>
                                     <option value="${outlet }">${outlet_name }</option>
                                </select>
                                </div>
                                <div class="form-group col-md-3">
