        ...
        <div class="content-page">
                ...
                <div class="col-lg-6">
                        ...
                        <div class="card-box ">
                            ...
                            <form method="POST" action="<%=dashboardURL %>editstate/${sid}" enctype="multipart/form-data" autocomplete="off">
                               <div class="row">
                               <div class="form-group col-md-12">
                                    <label for="state_name">State Name<span class="text-danger">*</span></label>
                                    <input type="text" required value="${state_name}" class="form-control" id="state_name" name="state_name" placeholder="Enter state name">
                                </div>
                                </div>
        	        ...
        	        success: function(response)
        	                    {
				        			...
				        			var jsonString=JSON.parse(Data);
				        	 	    ...
				        	 	    {
				        	 	 	  $("#outlets").append("<option selected='' value='"+jsonString[i].outlet_id+"'>"+jsonString[i].outlets+"</option>");
				        	 	    }                   
        	                    }
        	        });
        }
