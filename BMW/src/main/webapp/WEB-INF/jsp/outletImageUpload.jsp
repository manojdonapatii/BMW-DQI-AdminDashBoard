...
<div class="content-page">
                ...
                <div class="col-lg-4">
                        ...
                        <div class="card-box ">
                            ...
                            <form method="POST" action="<%=dashboardURL %>addOutletImages/${oid}" enctype="multipart/form-data"" autocomplete="off">
                               
                                <div class="form-group col-md-12">
                                    <label for="Address">Upload Image<span class="text-danger">*</span></label>
                                    <input type="file" required class="form-control" id="files" name="files" placeholder="">
                                </div>
                    ...
                    <div class="col-md-8">
                     <div class="card-box ">
                    <div class="row">
                     <c:forEach var="uBean" items="${getoutletImages}">
                    <div class="col-md-3"><img alt="${uBean.file_path }" src="<%=UI_PATH %>uploads/outlet/${uBean.file_path }" style="height: 150px;"></div>
                    </c:forEach>
                     </div>
                     </div>
                    </div>
