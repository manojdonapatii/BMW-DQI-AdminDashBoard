                            ...
                            <div class="btn-group pull-right">
                                <ol class="breadcrumb hide-phone p-0 m-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">Notifications</a></li>
                                     <li class="breadcrumb-item"><a href="#">Regional Manager</a></li>
                                </ol>
                            </div>
                            <h4 class="page-title">Regional Manager Notifications</h4>
                        </div>
                    </div>
                </div>
...
<!-- tab menu-->
        ...
        <div class="col-lg-3 col-md-3 col-sm-3">
			<div class="card">
                          ...
                          <button onclick="location.href='<%=dashboardURL%>regionalManagerNotifications';" class="btn btn-light button-width active"><i class="icon-camera"></i><span class="text-aligning">Reg. Manager Notifications</span></button>
                          ...
                          <button onclick="location.href='<%=dashboardURL%>EyiNotifications';" class="btn btn-light button-width "><i class="icon-camera"></i><span class="text-aligning">Eyi Notifications</span></button>
                         </div>
                    </div>
			</div>
        <!-- End tab menu-->
