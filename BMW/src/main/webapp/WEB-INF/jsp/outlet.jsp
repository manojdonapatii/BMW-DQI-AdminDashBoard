       ...
       <div class="content-page">
                ...
                <div class="col-lg-12">
                        ...
                        <div class="card-box ">
                            ...
                            <form method="POST" action="<%=dashboardURL %>createOutlet" enctype="multipart/form-data" autocomplete="off">
                               <div class="row">
                               ...
                               <div class="form-group col-md-6" >
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" required class="form-control" id="outlets" name="outlets" placeholder="Enter outlet name">
                                </div>
                                 <div class="form-group col-md-3">
                                    <label for="Address">Outlet ID<span class="text-danger"></span></label>
                                    <input type="text"  class="form-control" id="oid" name="oid" placeholder="Enter outlet ID">
                                </div>
                                <div class="form-group col-md-6">
