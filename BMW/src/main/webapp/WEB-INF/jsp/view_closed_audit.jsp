                         ...
                         <div class="card-box">
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <th>Outlet</th>
                                    <th>Outlet Type</th>
                                    <th>Audit Scheduled on</th>
                                     <th>Audit Closed on</th>
                                      <th>Audit Summary</th>
                                    <th>Action</th>
                                </tr>
                                </thead>
                                ...
                                <tr>
                                    <td>${uBean.dealership_name }</td>
                                      ...
                                      <td>${uBean.audit_summary }</td>
                                    <td><a href="<%=dashboardURL%>auditReOpen/${uBean.audit_id}" onclick="return confirm('Are you sure you want to re-open this audit?');">Re Open Audit</a></td>
                                </tr>
                                </c:forEach>
                                </tbody>
                            </table>
