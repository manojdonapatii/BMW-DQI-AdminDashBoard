                ...
                <div class="content">
                    ...
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Dealer Notifications</h4>
                        </div>
                    </div>
                </div>
...
<!-- tab menu-->
        ...
        <div class="col-lg-3 col-md-3 col-sm-3">
			<div class="card">
                          ...
                          <button onclick="location.href='<%=dashboardURL%>dealerNotifications';" class="btn btn-light button-width active"><i class="icon-user"></i><span class="text-aligning">Dealer Notifications</span></button>
