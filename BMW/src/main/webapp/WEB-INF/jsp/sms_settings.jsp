                        ...
                        <div class="page-title-box">
                            <div class="btn-group pull-right">
                                <ol class="breadcrumb hide-phone p-0 m-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">SMS Settings</a></li>
                                </ol>
                            </div>
...
<!-- tab menu-->
        ...
        <div class="col-lg-3 col-md-3 col-sm-3">
			<div class="card">
                          ...
                          <button onclick="location.href='<%=dashboardURL%>smsSettings';" class="btn btn-light button-width active"><i class="icon-user"></i><span class="text-aligning"> SMS</span></button>
				...
				<div class="col-lg-8 col-md-8 col-sm-8">                        
                      ...
                      <div class="card-box">
                       <div class="header">
                        ...
                        <form id="basic-form" method="POST" action="<%=dashboardURL %>smsSettings">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group">
                                      <label for="Address">SMS Template<span class="text-danger">*</span></label>
                                    <input type="text" required class="form-control" value="${sms_template}" id="sms_template" name="sms_template" placeholder="Enter SMS Template">
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group">
                                      <label for="Address">User Name<span class="text-danger">*</span></label>
                                    <input type="text" required class="form-control" value="${user_name}" id="user_name" name="user_name" placeholder="Enter User Name">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                    ...
                                    <input type="text" required class="form-control" value="${password}" id="password" name="password" placeholder="Enter Password">
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group">
                                         <label for="Address">Sender Id<span class="text-danger">*</span></label>
                                    <input type="text" required class="form-control" value="${sender_id}" id="sender_id" name="sender_id" placeholder="Enter Sender Id">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group">
                                       <label for="pass1">SMS For<span class="text-danger">*</span></label>
                                    <input type="text" required class="form-control" value="${sms_for}" id="sms_for" name="sms_for" placeholder="Enter SMS FOR">
